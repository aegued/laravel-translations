...
trait Translatable
{
    ...
    public function setAttribute($key, $value)
    {
        ...
        return $this->setTranslation($key, config('app.locale', config('translations.locale')), $value, true);
    }
    ...
    public function translations()
    {
        return $this->hasMany(Translation::class, 'foreign_key', $this->getKeyName())
            ...
            ->whereIn('locale', config('translations.locales', [config('translations.locale')]));
    }
    ...
    public function getTranslationsOf($attribute, array $languages = null, $fallback = true)
    {
        if (is_null($languages))
            $languages = config('translations.locales', [config('app.locale')]);
    ...
    {
        $default = config('translations.locale');
